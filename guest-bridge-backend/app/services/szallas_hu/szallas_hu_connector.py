...
#     VENDEGEM_RESERVATION_TYPE, DATE_FORMAT, VENDEGEM_GUEST_STATUS
...
#         }
#
#         for room_number, price in self.rooms.items():
...
#                     'lakoegysegDto': {
#                         'szallashelyKulsoId': accommodation.id,
#                         'kulsoId': accommodation.find_room_id_by_szallas_hu_name(room_number)['id']
#                     },
